    ...
    with gr.Row():
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox, elem_id="scrollable-box-hidden") as advanced_column:
            ...
            with gr.Tab(label='Extras', elem_id="scrollable-box"):
                ...
                with gr.Row():
                    gr.Markdown(label='System Information', value=f'Python {sys.version}<br>Comfy version: {comfy_version.version},Fooocus version: {fooocus_version.version}<br>SimpleSDXL2 version: {version.get_simplesdxl_ver()},FooocusPlus version: {fooocusplus_version.version})
